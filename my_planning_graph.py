...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return bool(len(set(node_a1.action.effect_add).intersection(set(node_a2.action.effect_rem))) | 
        len(set(node_a1.action.effect_rem).intersection(set(node_a2.action.effect_add))))
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return  bool(len(set(node_a1.action.effect_add).intersection(set(node_a2.action.precond_neg))) |
            len(set(node_a2.action.effect_add).intersection(set(node_a1.action.precond_neg))) |
            len(set(node_a1.action.effect_rem).intersection(set(node_a2.action.precond_pos))) |
            len(set(node_a2.action.effect_rem).intersection((node_a1.action.precond_pos))))
